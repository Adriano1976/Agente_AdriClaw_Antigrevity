...
- [x] Setup [tsconfig.json](file:///c:/Users/Neide%20Ferreira/3D%20Objects/AdriClaw/tsconfig.json) and basic project structure
- [x] Create mandatory directories: [data/](file:///c:/Users/Neide%20Ferreira/3D%20Objects/AdriClaw/src/skills/SkillLoader.ts#5-11), `tmp/`, `.agents/skills/`
